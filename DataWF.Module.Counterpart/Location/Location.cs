...
namespace DataWF.Module.Counterpart
{
    ...
    public class Location : DBGroupItem
    {
        ...
        {
            var euas = new Location { LocationType = Counterpart.LocationType.Continent, Code = "EUAS", Name = "Eurasia" }; euas.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "AF", CodeI = "", Name = "Africa" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "AN", Name = "Antarctica" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "AS", Name = "Asia" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "EU", Name = "Europa" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "NA", Name = "North america" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "OC", Name = "Oceania" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.Continent, Code = "SA", Name = "South america" }.SaveOrUpdate();
            ...
            new Location { LocationType = Counterpart.LocationType.City, Parent = russia, Code = "495", Name = "Moskow" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.City, Parent = kazakh, Code = "727", Name = "Almaty" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.City, Parent = kazakh, Code = "7172", Name = "Astana" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.City, Parent = kazakh, Code = "7122", Name = "Atyrau" }.SaveOrUpdate();
            new Location { LocationType = Counterpart.LocationType.City, Parent = kazakh, Code = "7292", Name = "Aktau" }.SaveOrUpdate();
