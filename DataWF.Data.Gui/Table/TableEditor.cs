...
namespace DataWF.Data.Gui
{
    ...
    public class TableEditor : ListEditor, ILocalizable, ILoader, IReadOnly
    {
        ...
        private GlyphMenuItem toolInsertLine = new GlyphMenuItem();
            ...
            : base(new LayoutDBTable())
        {
            ...
            toolInsertLine.Clicked += OnToolInsertItemClicked;
                        ...
                        if (OwnerRow != null)
                        {
                            foreach (DBForeignKey relation in OwnerRow.Table.GetChildRelations())
                            {
                                if (!relation.Table.Access.View)
                                    continue;
                                var itemRelation = refButton.DropDownItems.GetByName(relation.Name) as MenuItemRelation;
