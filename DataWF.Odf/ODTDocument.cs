...
namespace Doc.Odf
{
    ...
    public class ODFDocument
    {
        ...
        public ODFDocument(Stream value)
        {
            Load(value);
        }
        ...
        public Frame GetFrame(byte[] im, double width, double heigth, double maxWidth)
        {
            Frame frame = new Frame(this);
            frame.Width.Data = width;
            frame.Height.Data = heigth;
