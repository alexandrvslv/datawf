...
namespace System.Text.Json
{
    ...
    // https://github.com/evil-dr-nick/utf8jsonstreamreader/blob/master/Utf8JsonStreamReader/Utf8JsonStreamReader.cs
    ...
    public ref struct Utf8JsonStreamReader
    {
        ...
        private void MoveNext()
        {
            ...
            do
            {
                var span = newSegment.Buffer.Memory.Span.Slice(_lastSegmentEndIndex);
        ...
        {
            return JsonSerializer.Deserialize(ref _jsonReader, type, options);
        }
    ...
    public static class NetStandard20to21Extensions
    {
        public static int Read(this Stream stream, Span<byte> buffer)
        {
            ...
            try
            {
                ...
                {
                    throw new IOException("IO StreamTooLong");
                }
